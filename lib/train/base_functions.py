...
from lib.train.dataset.mgit import MGIT
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        assert name in ["LASOT", "GOT10K_vottrain", "GOT10K_votval", "GOT10K_train_full",
                        ...
                        "REFCOCOG", "TNL2K_train", "OTB99_train","VASTTRACK","LASOT_Lang", "TNL2K", "TNL2K_Lang", "OTB_Lang", "RefCOCO14","MGIT"]
        ...
        # if name == "MGIT":
        #     datasets.append(MGIT(settings.env.mgit_dir, split='train', image_loader=image_loader, multi_modal_vision=settings.multi_modal_vision,
        #                               multi_modal_language=settings.multi_modal_language))

        if name == "MGIT":
            datasets.append(MGIT(settings.env.mgit_dir, split='train'))
